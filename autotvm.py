...
model_url = "".join(
    [
        ...
        "master/vision/classification/densenet-121/model/",
        "densenet-9.onnx",
    ]
)

#print(model_url)
model_path = download_testdata(model_url, "densenet-9.onnx", module="onnx")
#print(model_path)
...
#img_path='/home/nvidianx/.tvm_test_data/data/imagenet_cat.jpg'
print(img_path)
...
print("The time to build unoptimized model is",time_diff)

tmp = utils.tempdir()
lib_fname = tmp.relpath("/home/nvidianx/TVM/tvm/engine1_cpu_unopt_densenet.tar")
...
tuning_option = {
    ...
    "tuning_records": "resnet-50-v2-autotuning1.json",
}
...
tmp = utils.tempdir()
lib_fname = tmp.relpath("/home/nvidianx/TVM/tvm/engine1_cpu_opt_densenet.tar")
lib.export_library(lib_fname)
